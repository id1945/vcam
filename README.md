Chú ý: cài TeamWin - TWRP (Team Win Recovery Project) trước để có thể cứu máy khi bị lỗi treo logo
...
Note:
Safetynet-fix: Nếu bạn vẫn gặp sự cố khi vượt qua SafetyNet hoặc Play Integrity với mô-đun này, hãy giả mạo hồ sơ của thiết bị đã được chứng nhận bằng cách sao chép ro.product các thuộc tính.
https://github.com/kdrag0n/safetynet-fix

Shamiko v1.2: Công cụ ẩn Root phiên bản Pro trên điện thoại Android đang được phát triển
